...
public class Cabin {
        ...
        while (true) {
            ...
            switch (userInputUpperCase) {  //Menu selection
                case "V":
                    ...
                    break;
                case "A":
                    Add(cabinFirstName,cabinSecondName,expenses);
                    break;
                case "E":
                    Empty(cabinFirstName);
                    break;
                case "D":
                    Delete(cabinFirstName,cabinSecondName,expenses);
                    break;
                case "F":
    ...
    private static void Add(String[][] cabinFirstName, String[][] cabinSecondName, int[][] expenses){
        Scanner input = new Scanner(System.in);
        String cabinName1;
        ...
        while (true) {
            ...
            if ((cabinNum >= 0) && (cabinNum <= 11)) {
                if ((cabinFirstName[cabinNum][0].equals("e")) && (cabinFirstName[cabinNum][1].equals("e")) && (cabinFirstName[cabinNum][2].equals("e"))) {  // Code for cabin space for 3 passengers
                ...
                } else if (((cabinFirstName[cabinNum][0].equals("e")) && (cabinFirstName[cabinNum][1].equals("e"))) || ((cabinFirstName[cabinNum][1].equals("e")) && (cabinFirstName[cabinNum][2].equals("e"))) || ((cabinFirstName[cabinNum][0].equals("e")) && (cabinFirstName[cabinNum][2].equals("e")))) {  // Code for cabin space for 2 passengers
                    System.out.println("Maximum 2 passengers can be allocate.");
                    System.out.println("How many passengers you want to allocate for cabin " + cabinNum + " : ");
                    passengerNum = input.nextInt();
                    if (passengerNum == 1) {
                        System.out.println("Enter passenger's first name : ");
                ...
                } else if ((cabinFirstName[cabinNum][0].equals("e")) || (cabinFirstName[cabinNum][1].equals("e")) || (cabinFirstName[cabinNum][2].equals("e"))){  // Code for cabin space for 1 passenger
                    System.out.println("Only 1 passenger can be allocate.");
                    System.out.println("How many passengers you want to allocate for cabin " + cabinNum + " : ");
                    passengerNum = input.nextInt();
                    if (passengerNum == 1) {
                        System.out.println("Enter passenger's first name : ");
                    ...
                    System.out.println("Cabin is fully occupied. No further passengers can be allocated. Please try another cabin number.");
                }
            } else if (cabinNum == 12) {
            ...
            if ((cabinNum >= 0) && (cabinNum <= 11)) {
                ...
                if (passengerNum > 2 ) {
                    ...
                    if (!(cabinFirstName[cabinNum][0].equals("e")) && (cabinFirstName[cabinNum][1].equals("e") && !(cabinFirstName[cabinNum][2].equals("e")))){
                        cabinFirstName[cabinNum][1] = cabinFirstName[cabinNum][2];
                        cabinFirstName[cabinNum][2] = "e";
                        cabinSecondName[cabinNum][1] = cabinSecondName[cabinNum][2];
                        cabinSecondName[cabinNum][2] = "e";
                        expenses[cabinNum][1] = expenses[cabinNum][2];
                        expenses[cabinNum][2] = 0;
                    }else if ((cabinFirstName[cabinNum][0].equals("e")) && !(cabinFirstName[cabinNum][1].equals("e") && !(cabinFirstName[cabinNum][2].equals("e")))){
                        cabinFirstName[cabinNum][0] = cabinFirstName[cabinNum][2];
                        cabinFirstName[cabinNum][2] = "e";
                        cabinSecondName[cabinNum][0] = cabinSecondName[cabinNum][2];
                        cabinSecondName[cabinNum][2] = "e";
                        expenses[cabinNum][0] = expenses[cabinNum][2];
                        expenses[cabinNum][2] = 0;
                    }else if ((cabinFirstName[cabinNum][0].equals("e")) && !(cabinFirstName[cabinNum][1].equals("e") && (cabinFirstName[cabinNum][2].equals("e")))){
                        cabinFirstName[cabinNum][0] = cabinFirstName[cabinNum][1];
                        cabinFirstName[cabinNum][1] = "e";
                        cabinSecondName[cabinNum][0] = cabinSecondName[cabinNum][1];
                        cabinSecondName[cabinNum][1] = "e";
                        expenses[cabinNum][0] = expenses[cabinNum][1];
                        expenses[cabinNum][1] = 0;
                    }else if ((cabinFirstName[cabinNum][0].equals("e")) && (cabinFirstName[cabinNum][1].equals("e") && !(cabinFirstName[cabinNum][2].equals("e")))){
                        cabinFirstName[cabinNum][0] = cabinFirstName[cabinNum][2];
                        cabinFirstName[cabinNum][2] = "e";
                        cabinSecondName[cabinNum][0] = cabinSecondName[cabinNum][2];
    ...
    private static void expenses(int[][] expenses ){
        int counter = 0;
        int totalExpense;
        int passengerExpense = 1000;
        System.out.println(Arrays.deepToString(expenses));
        for(int i = 0; i < expenses.length; i++) {  //Getting the number of passengers to calculate total passenger expense
            for(int j = 0; j < 3; j++) {
                if(!(expenses[i][j] == 0)) {
                    counter++;
                }
